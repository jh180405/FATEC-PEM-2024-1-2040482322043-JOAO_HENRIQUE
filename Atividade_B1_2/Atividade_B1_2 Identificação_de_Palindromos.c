...
int main() {
    char frase[100];
    char palavraAtual[50]; // Suponha que uma palavra não tenha mais de 50 caracteres
    int comeco = 0;
    int final;
    int pali = 1;
    ...
    final = strlen(frase) - 2; // Removendo o '\n' do fgets
